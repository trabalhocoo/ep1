...
public class RegistroOutros extends Registrador {
	...
	public static void registrarSessao(String texto, Sessao sessao, Usuario usuario){
		String informacoesDaSessao = "Criou a sess„o:  N∫ da Sessao : "+sessao.getNumero() + " Filme: "  + sessao.getFilme().getNome() + " Sala: " + sessao.getSala().getNumero();// teoicamente deveria ter tb o horario
