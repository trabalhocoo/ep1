...
public class CriarSalaFrame extends JFrame {
	...
	public CriarSalaFrame(final Usuario usr) {
		...
		JLabel lblPorFavorPreencha = new JLabel(
				"Por favor preencha as informacoes abaixo sobre a sala que deseja criar:");
		...
		criarSalaBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (textcapacidade.getText().equals("")
						|| textnumeroDaSala.getText().equals("")) {
					avisoLabel.setText("Por favor, preencha todos os campos.");
				} else {
					try {
						int capacidade = Integer.parseInt(textcapacidade
								.getText());
