...
public class EditarUsuarioFrame extends JFrame {
	...
	public EditarUsuarioFrame(final Usuario usrLogado) {
		...
		JLabel lblDigiteONumero = new JLabel(
				"Digite o numero do registro de usuario que deseja alterar:");
		...
		btnAdicionar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if (textField_1.getText().equals("")
					...
					lblNewLabel_2
							.setText("Por favor, preencher todos os campos.");
				} else {
					...
					try {
						...
						// System.out.println (nome + " " + permissao + " " +
						// senha);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (textField.getText().equals("")) {
					lblNewLabel_2
							.setText("Digite o numero de registro do usuário.");
				} else {
					boolean alterou = false;
					lblNewLabel_2.setText("");
					try {
						...
						if (registro < 1) {
							lblNewLabel_2
									.setText("Digite apenas valores maiores que zero.");
							textField.setText("");
							textField_1.setText("");
							textField_2.setText("");
						} else {
							Usuario usuarioAAlterar = Banco
									.obterUsuario(registro);

							if (usuarioAAlterar == null) {
								lblNewLabel_2
										.setText("Usuario nao encontrado.");
								textField.setText("");
								textField_1.setText("");
								textField_2.setText("");
							} else {
