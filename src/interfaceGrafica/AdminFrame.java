...
public class AdminFrame extends JFrame {
	...
	public AdminFrame(final Administrador usuario) {
		...
		JLabel label_1 = new JLabel("2 - Editar usu�rio");
		label_1.setFont(new Font("Tahoma", Font.PLAIN, 12));
		label_1.setBounds(38, 96, 114, 14);
		getContentPane().add(label_1);
		
		JLabel label_2 = new JLabel("3 - Deletar usu�rio");
		label_2.setFont(new Font("Tahoma", Font.PLAIN, 12));
		label_2.setBounds(38, 121, 114, 14);
		getContentPane().add(label_2);
		
		JLabel label_3 = new JLabel("4 - Listar usu�rio");
		...
		JLabel label_7 = new JLabel("15 - Remover sess�o");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				case 2:
					...
					//usufr.showIt("Editar Usu�rio");
					break;
				case 3:
					//Remover usuario
					//CriarUsuarioFrame usufr = new CriarUsuarioFrame();
					//usufr.showIt("Remover Usu�rio");
					break;
				case 4:
					//Exibir usuarios
				...
				default:
					...
					textField.setText("");
					lblNewLabel_1.setText("Digite uma op��o v�lida.Tente novamente");
