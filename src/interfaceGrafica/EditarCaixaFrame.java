...
public class EditarCaixaFrame extends JFrame {
	...
	public EditarCaixaFrame(Usuario usrLogado) {
		...
		JLabel label = new JLabel(
				"Digite o numero do caixa que deseja alterar: ");
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (numeroDigitado < 1) {
						...
						lblAviso.setText("Digite apenas valores maiores que 0.");
					} else {
					...
					lblAviso.setOpaque(false);
					lblAviso.setForeground(Color.red);
					lblAviso.setText("Digite apenas valores numericos.");
				}
			}
		});
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					if (Double.parseDouble(textSaldo.getText()) < 0) {
						...
						lblAviso.setText("O novo número para o Caixa deve ser maior que 0.");
					}else if (numeroCaixa.getText().equals("")
							|| textNumeroDoCaixa.getText().equals("")
							|| textSaldo.getText().equals("")) {
						lblAviso.setText("Por favor, digite todos os campos.");
					} else if (pretendenteDeCaixa != null
							&& !(numeroCaixa.getText().equals(textNumeroDoCaixa
									.getText()))) {
						...
						dadosCaixa.add(Integer.parseInt(textNumeroDoCaixa
								.getText()));
