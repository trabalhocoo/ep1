...
public class CriarSessaoFrame extends JFrame {
	...
	public CriarSessaoFrame(final Usuario usuarioLogado) {
		...
		lblAviso.setBounds(55, 67, 420, 14);
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (campoNomeFilme == null || campoAno == null
					...
					try {
						...
						if (year < 0 || month < 0 || date < 1 || hourOfDay < 0
								|| minute < 0 || nroSala < 1 || preco < 0) {
							lblAviso.setOpaque(false);
							lblAviso.setForeground(Color.red);
							lblAviso.setText("Digite valores maiores que 0 e para sala maiores que 1");
						} else {
							...
							if (isAdicionado) {
								...
								lblAviso.setOpaque(false);
								lblAviso.setForeground(Color.red);
								lblAviso.setText("Houve um problema ao criar a sessão. Tente rever os valores fornecidos");
							}
						}
